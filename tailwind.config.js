...
// Explicitly import only the colors we need to avoid deprecated color warnings
// The deprecated colors (lightBlue, warmGray, trueGray, coolGray, blueGray)
// have getters that trigger warnings when accessed
const safeColors = {
  inherit: 'inherit',

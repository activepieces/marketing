...
<template>
  <div class="bg-white min-h-screen">
    ...
    <section class="py-12 px-4">
      <!-- Automate mode -->
      <div v-if="productMode === 'automate'" class="bg-[rgba(49,43,96,0.05)] p-4 sm:p-6 md:p-10 rounded-3xl max-w-[1080px] mx-auto">
      ...
      <!-- Embed mode -->
      <div v-else class="bg-[rgba(49,43,96,0.05)] p-4 sm:p-6 md:p-10 rounded-3xl max-w-[1080px] mx-auto flex justify-center">
        <PricingPlanCard
          icon="stack"
          ...
          cta-style="solid"
          :features="[
            { text: 'Embedded Automation Builder', description: null, isHighlighted: false },
            { text: 'Embedded AI Agents', description: null, isHighlighted: false },
            { text: 'JavaScript SDK', description: null, isHighlighted: false },
            { text: 'Custom Templates & Branding', description: null, isHighlighted: false },
            { text: 'Piece Management', description: null, isHighlighted: false },
            { text: 'Private Pieces', description: null, isHighlighted: false },
            { text: 'Cloud or Self-Hosted', description: null, isHighlighted: false },
            { text: 'Dedicated Support', description: null, isHighlighted: false },
          ]"

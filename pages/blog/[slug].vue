          ...
          <header class="mb-4 lg:mb-6 not-format">  
              ...
              <div class="flex justify-between items-center py-4 border-t border-b border-gray-200 dark:border-gray-700">
                  <div class="mr-4 text-sm">
                      <address class="inline not-italic">By <a rel="author" class="text-gray-900 no-underline dark:text-white hover:underline" href="#">{{ post.attributes.author.data.attributes.name }}</a></address> in <a href="#" class="text-gray-900 no-underline dark:text-white hover:underline">Design</a>

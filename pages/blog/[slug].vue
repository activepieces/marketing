...
<template>
    <main class="py-8 lg:py-16 bg-white dark:bg-gray-900 antialiased">
        ...
        <div class="flex justify-between mx-auto max-w-screen-xl">
            <aside class="flex-shrink flex-grow-0 hidden relative mx-auto xl:block" aria-labelledby="sidebar-label">
                <div
                    ...
                    <a :href="`https://twitter.com/intent/tweet?text=${post.attributes.title}+${currentUrl}`"
                        ...
                        type="button">
                        <svg class="w-5 h-5" aria-hidden="true" viewBox="0 0 16 17" fill="none"
                        ...
                        <svg class="w-5 h-5" aria-hidden="true" viewBox="0 0 16 17" fill="none"
                            ...
                            <defs>
                                <clipPath id="clip0_13664_80011">
                                    <rect width="16" height="16" fill="white" transform="translate(0 0.443604)" />
                                </clipPath>
                            </defs>
                        </svg>
                    </a>
            ...
            <div id="share-twitter" role="tooltip"
                class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                Share on Twitter
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            <div id="share-facebook" role="tooltip"
                class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                Share on Facebook
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            <div id="share-reddit" role="tooltip"
                class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                Share on Reddit
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            <div id="share-linkedin" role="tooltip"
                class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                Share on LinkedIn
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            <article
                class="mx-auto w-full format px-10 format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            ...
            <aside class="shrink-0 hidden relative xl:block xl:w-80" aria-labelledby="sidebar-label">
                ...
                <div class="sticky top-20">
                    <div
                        class="flex flex-col gap-4 justify-center p-10 items-center w-full bg-primary-50 rounded-lg dark:bg-gray-800">
                        ...
                        <a href="https://cloud.activepieces.com/sign-up"
                            class="w-full mt-4 text-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-lg px-4 py-2 lg:px-5 lg:py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Sign
                            up for free</a>
                    </div>
                </div>
            </aside>
    ...
    <aside v-if="relatedPosts.data.length > 0" aria-label="Related articles"
...
.format {
    ...
    /*max-width:65ch;*/
    --tw-format-body: #231c33;
    --tw-format-headings: #231c33;
    --tw-format-lead: #6b7280;
    --tw-format-links: #4b5563;
    --tw-format-bold: #231c33;
    --tw-format-counters: #6b7280;
    --tw-format-bullets: #6b7280;
    --tw-format-hr: #e5e7eb;
    --tw-format-quotes: #231c33;
    --tw-format-quote-borders: #e5e7eb;
    --tw-format-captions: #6b7280;
    --tw-format-code: #231c33;

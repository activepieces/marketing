<template>
  <div class="relative w-full h-full min-h-[600px]">
    ...
    <div v-if="browserClosed" class="absolute inset-0 z-5 overflow-hidden">
      <!-- Countdown on LEFT -->
      <div
      ...
      >
        ...
        <div
          class="p-5 bg-gradient-to-br from-[#1a1a2e] to-[#0d0d1a]"
          style="min-height: 170px"
        >
          <div class="flex items-center gap-2 mb-4">
            <div
              class="w-7 h-7 rounded-lg bg-[#ff6d5a] flex items-center justify-center text-white font-bold text-[10px]"
            >
              n8n
            </div>
            <span class="text-white font-semibold text-sm">n8n</span>
          </div>
          <p class="text-white/80 text-sm mb-4">For technical teams</p>
          <div class="space-y-2">
      ...
      >
        ...
        <div
          class="p-5 bg-gradient-to-br from-[#ff4a00] to-[#ff8c00]"
          style="min-height: 170px"
        >
          <div class="flex items-center gap-2 mb-4">
            <div
              class="w-7 h-7 rounded-lg bg-white flex items-center justify-center"
            >
              <PhLightning class="w-4 h-4 text-[#ff4a00]" weight="fill" />
            </div>
            <span class="text-white font-semibold text-sm">Zapier</span>
          </div>
          <p class="text-white/90 text-sm mb-4">10+ products. Figure it out.</p>
          <div class="space-y-2">
      ...
      >
        ...
        <div class="bg-gray-200/80 px-4 py-3 flex items-center gap-2">
          <div class="flex gap-2 group/traffic">
            ...
            <div
              class="w-3 h-3 rounded-full bg-yellow-400 flex items-center justify-center"
            >
              <svg
            ...
            <div
              class="w-3 h-3 rounded-full bg-green-400 flex items-center justify-center"
            >
              <svg
        ...
        <div class="relative">
          ...
          <Transition name="thief">
            <div
              v-if="showThief"
              class="absolute inset-0 z-[100] pointer-events-none rounded-b-2xl overflow-hidden"
            >
              <!-- Dark overlay -->
              ...
              <div
                v-for="i in 12"
                :key="'ninja-' + i"
                class="absolute thief-float"
                :style="getThiefPosition(i)"
              >
                <PhMaskHappy
                  class="text-white/70"
                  weight="fill"
                  :style="{
                    width: getThiefPosition(i).fontSize,
                    height: getThiefPosition(i).fontSize,
                  }"
                />
              </div>
              ...
              <div
                v-for="i in 8"
                :key="'loot-' + i"
                class="absolute thief-loot"
                :style="getLootPosition(i)"
              >
                <component
                  ...
                  weight="fill"
                  :style="{
                    width: getLootPosition(i).fontSize,
                    height: getLootPosition(i).fontSize,
                  }"
                />
              </div>
          ...
          <Transition name="modal">
            ...
            >
              ...
              <!-- Header - fixed at top -->
              <div
                class="pt-6 pb-4 text-center relative z-10 bg-gradient-to-b from-black via-black/80 to-transparent w-full"
              >
                <PhTimer
              ...
              <div class="flex-1 w-full overflow-hidden relative">
                ...
                <div class="credits-roll text-center px-6 pt-8">
                  ...
                  >
                    <h4
                      class="text-emerald-400 text-xs font-bold tracking-[0.3em] mb-4"
                    >
                      {{ section.category }}
                    </h4>
                    <div class="space-y-2">
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <button
                @click="flexToBoss"
                class="group px-3 py-1.5 bg-gradient-to-r from-rose-500 to-pink-600 text-white text-xs font-semibold rounded-lg hover:-translate-y-0.5 transition-all flex items-center gap-1.5"
              >
              ...
              >
                ...
                <div class="relative">
                  ...
                  <div class="text-2xl font-bold text-gray-900 tabular-nums">
                    ...
                    >
                      {{ stat.prefix }}{{ animatedStats[index]
                      }}{{ stat.suffix }}
                    </span>
                  </div>
            ...
            <Transition name="modal">
              ...
              >
                ...
                >
                  <!-- Header -->
                  <div
                    class="bg-gradient-to-r from-rose-500 to-pink-600 px-6 py-4 flex items-center justify-between"
                  >
                    <div class="flex items-center gap-3">
                      <PhEnvelope class="w-8 h-8 text-white" weight="fill" />
                      <div>
                        <h4 class="font-bold text-white text-lg">
                          Operation: Get That Bag
                        </h4>
                        <p class="text-rose-200 text-xs">
                          Time to secure the promotion
                        </p>
                      </div>
                    </div>
                    <button
                  ...
                  <div class="p-6">
                    ...
                    >
                      ...
                      >
                        ...
                        <p>
                          First of all, I just want to say that everyone on the
                          team agrees you're literally the best boss in the
                          entire universe. Like, we had a meeting about it.
                          Unanimous vote.
                        </p>

                        <p>
                          ANYWAY, completely unrelated, but check out these
                          numbers:
                        </p>
                        ...
                        <p>
                          Did I mention your new haircut looks great? Because it
                          really does.
                        </p>
                        ...
                        <p class="pt-2">
                          ...
                          <span class="font-medium"
                            >The One Who Deserves a Raise</span
                          >
                        </p>
                      </div>
                    </div>
...
const hoursCreditsList = [
  ...
  {
    category: "12,400 HOURS RECLAIMED",
    items: [
...
const stats = [
  ...
  },
  {
    label: "Automations",
    value: 2341,
    iconComponent: markRaw(PhLightning),
  ...
  },
  {
    label: "Adoption Rate",
    value: 94,
    iconComponent: markRaw(PhTrendUp),
...
const activities = ref([
  {
    user: "Sarah Chen",
    action: 'created "Lead Scoring Agent"',
    time: "2 min ago",
    avatar: "SC",
    bgColor: "rgba(139, 92, 246, 0.2)",
    iconComponent: markRaw(PhRocket),
    iconClass: "text-violet-400",
  },
  {
    user: "Mike Johnson",
    action: 'earned "Power User" badge',
    time: "15 min ago",
    avatar: "MJ",
    bgColor: "rgba(245, 158, 11, 0.2)",
    iconComponent: markRaw(PhTrophy),
    iconClass: "text-amber-400",
  },
  {
    user: "Emma Wilson",
    action: "automated 50th workflow",
    time: "1 hour ago",
    avatar: "EW",
  ...
  {
    user: "Alex Kumar",
    action: "joined from Engineering",
    time: "2 hours ago",
    avatar: "AK",
    bgColor: "rgba(236, 72, 153, 0.2)",
    iconComponent: markRaw(PhHandWaving),
    iconClass: "text-pink-400",
  },
]);
...
onMounted(() => {
  ...
  activityInterval = setInterval(() => {
    const newActivities = [
      {
        user: "Tom Harris",
        action: 'built "Slack Notifier"',
        time: "Just now",
        avatar: "TH",
        bgColor: "rgba(99, 102, 241, 0.2)",
        iconComponent: markRaw(PhSparkle),
        iconClass: "text-indigo-400",
      },
      {
        user: "Lisa Park",
        action: "reached 100 hours saved",
        time: "Just now",
        avatar: "LP",
        bgColor: "rgba(250, 204, 21, 0.2)",
        iconComponent: markRaw(PhConfetti),
      ...
      },
      {
        ...
        iconComponent: markRaw(PhUpload),
...
.modal-enter-from .boss-report-enter,
.modal-leave-to .boss-report-enter {
...
.dept-list-enter-active,
.dept-list-leave-active {
  transition: all 0.3s ease;
}
.dept-list-enter-from,
.dept-list-leave-to {
  opacity: 0;
  transform: translateX(-20px);
}

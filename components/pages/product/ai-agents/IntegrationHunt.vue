  ...
  <div>
    ...
    >
      ...
      <span 
        ...
        :class="target.health === 2 ? 'bg-blue-500 text-white' : 'bg-orange-500 text-white animate-pulse'"
      >
        {{ target.health }}x
      </span>
    ...
    >
      <div class="text-center px-8">
        ...
        <p class="text-purple-600 font-bold text-xl mb-2">Integration Hunter</p>
        <p class="text-purple-400 text-sm mb-4">Catch them all! Don't let them escape!</p>
        <div class="space-y-1 text-purple-300 text-xs mb-4">
          <p><span class="font-mono bg-purple-100 px-1.5 py-0.5 rounded">Mouse</span> or <span class="font-mono bg-purple-100 px-1.5 py-0.5 rounded">← →</span> move</p>
          <p><span class="font-mono bg-purple-100 px-2 py-0.5 rounded">Space</span> / <span class="font-mono bg-purple-100 px-1.5 py-0.5 rounded">Click</span> shoot</p>
        </div>
        <button 

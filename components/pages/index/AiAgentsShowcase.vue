    ...
    <div class="relative max-w-7xl mx-auto px-4">
      ...
      <div class="flex items-center justify-center gap-2 mb-8">
        ...
        >
          ...
          <span
            ...
            :style="{
              transform: `scaleX(${isAutoPlaying ? progress / 100 : 1})`,
            }"
          ></span>
      ...
      >
              ...
              >
                <div class="p-4 space-y-3">
                  ...
                  <div>
                    ...
                    <div
                      v-if="activeIndex === 0"
                      class="p-3 rounded-lg bg-violet-50 border border-violet-200 min-h-[60px]"
                    >
                      <p class="text-sm text-gray-700 leading-relaxed">
                        {{ typedPrompt
                        }}<span
                          v-if="isTyping"
                          class="inline-block w-0.5 h-4 bg-violet-500 ml-0.5 animate-pulse"
                        ></span>
                      </p>
                    </div>
                    <div
                      v-else
                      class="p-3 rounded-lg bg-gray-100 border border-gray-200 min-h-[60px] space-y-2"
                    >
                  ...
                  <div class="grid grid-cols-2 gap-2">
                    ...
                    >
                      <p
                        class="text-[9px] font-bold text-gray-400 uppercase mb-2"
                      >
                        Trigger
                      </p>
                      <div
                      ...
                      >
                        <div
                          class="w-7 h-7 rounded-md bg-white border border-gray-200 flex items-center justify-center flex-shrink-0"
                        >
                          <img
                      ...
                      <div v-else class="flex items-center gap-2.5">
                        <div
                          class="w-7 h-7 rounded-md bg-gray-200 flex-shrink-0"
                        ></div>
                    ...
                    >
                      <p
                        class="text-[9px] font-bold uppercase mb-2"
                        :class="
                          activeIndex === 1
                            ? 'text-violet-500'
                            : 'text-gray-400'
                      ...
                      >
                        ...
                        <div
                          class="w-7 h-7 rounded-md bg-violet-100 border border-violet-200 flex items-center justify-center flex-shrink-0"
                        >
                      ...
                      <div v-else class="flex items-center gap-1">
                        ...
                        ></div>
                        <div
                          class="w-7 h-7 rounded-md bg-violet-200 border-2 border-violet-400 flex items-center justify-center flex-shrink-0 animate-pulse"
                        >
                          <span class="text-[10px] font-bold text-violet-600"
                            >+</span
                          >
        ...
        <Transition name="slide-in">
          <div
            v-if="activeIndex === 1"
            class="absolute inset-0 flex items-center justify-center p-6 z-40"
          >
            ...
            <div class="flex items-start">
              ...
              <div class="w-64 -ml-16 relative z-50">
                ...
                <div
                  class="px-4 py-3 border border-gray-200 border-b-0 rounded-t-xl bg-white"
                >
                ...
                <div class="p-3 border-x border-gray-200 bg-white relative">
                  <div class="grid grid-cols-4 gap-2">
                    ...
                    >
                      ...
                      <span
                        class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-900 text-white text-[10px] rounded whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-[200]"
                      >
                        {{ app.name }}
                      </span>
                    </div>
                ...
                <div
                  class="px-4 py-3 bg-gray-50 border border-gray-200 border-t-gray-100 rounded-b-xl flex items-center justify-between"
                >
                  <p class="text-gray-900 font-semibold">
                    {{ displayPiecesCount }}+ apps
                  </p>
          ...
          >
            ...
            <div class="relative" style="width: 390px; height: 400px">
              ...
              <div class="absolute" style="left: 115px; top: 0px; width: 160px">
                ...
                <div
                  class="rounded-xl border border-gray-200 shadow-sm bg-white px-3 py-2.5"
                >
                  <div class="flex items-center gap-2.5">
                    <div
                      class="w-8 h-8 rounded-lg bg-pink-50 flex items-center justify-center flex-shrink-0"
                    >
                      <img
                        src="https://cdn.activepieces.com/pieces/hubspot.png"
                        class="w-[19px] h-[19px]"
                    ...
                    <div class="flex-1 min-w-0">
                      <div
                        class="font-medium text-gray-900 text-sm truncate leading-tight"
                      >
                        1. New Lead
                      </div>
                      <div class="text-gray-500 text-xs truncate leading-tight">
                        HubSpot
                      </div>
                    </div>
                  </div>
              ...
              <div
                ref="slot2"
                class="absolute"
                style="left: 115px; top: 87px; width: 160px; height: 52px"
              ></div>
              ...
              >
                <div
                  class="rounded-xl border border-amber-200 shadow-sm bg-white px-3 py-2.5"
                >
                  <div class="flex items-center gap-2.5">
                    <div
                    ...
                    >
                      <svg
                        class="w-[19px] h-[19px] text-amber-500"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
              ...
              >
                <div
                  class="rounded-xl border border-pink-200 shadow-sm bg-white px-3 py-2.5"
                >
                  <div class="flex items-center gap-2.5">
                    <div
                      class="w-8 h-8 rounded-lg bg-pink-50 flex items-center justify-center flex-shrink-0"
                    >
                      <svg
                        class="w-[19px] h-[19px] text-pink-500"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                <div class="p-4">
                  <div class="flex gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div
                        class="space-y-2 text-[15px] text-gray-800 leading-relaxed"
                      >
                        <p>
                          Hey! <strong>Sarah Chen</strong> from TechCorp just
                          signed up.
                        </p>
                      ...
                      <div class="flex gap-2 mt-3">
                        <button
                          class="px-4 py-1.5 bg-[#007a5a] hover:bg-[#148567] text-white text-sm font-medium rounded transition-colors"
                        >
                          Send intro
                        </button>
                        <button
                          class="px-4 py-1.5 bg-white hover:bg-gray-50 text-gray-700 text-sm font-medium rounded border border-gray-300 transition-colors"
                        >
                          Skip
                        </button>
                      </div>
        ...
        <Transition name="slide-in">
          ...
          >
            ...
            <div class="relative h-full overflow-hidden">
              ...
              <div
                class="absolute top-1/2 -translate-y-1/2 h-[50px] pointer-events-none"
                style="left: calc(50% + 110px); right: 0"
              >
                <!-- Write particles (going right) -->
                <span
                  class="particle-dot bg-emerald-500"
                  style="top: 15px; animation-delay: 0s"
                ></span>
                <span
                  class="particle-dot bg-emerald-500 opacity-70"
                  style="top: 15px; animation-delay: 0.2s"
                ></span>
                <span
                  class="particle-dot bg-emerald-500 opacity-50"
                  style="top: 15px; animation-delay: 0.4s"
                ></span>
                <span
                  class="particle-dot bg-emerald-500 opacity-35"
                  style="top: 15px; animation-delay: 0.6s"
                ></span>
                <span
                  class="particle-dot bg-emerald-500 opacity-20"
                  style="top: 15px; animation-delay: 0.8s"
                ></span>
                <!-- Read particles (going left) -->
                <span
                  class="particle-dot-reverse bg-violet-500"
                  style="top: 29px; animation-delay: 0s"
                ></span>
                <span
                  class="particle-dot-reverse bg-violet-500 opacity-70"
                  style="top: 29px; animation-delay: 0.2s"
                ></span>
                <span
                  class="particle-dot-reverse bg-violet-500 opacity-50"
                  style="top: 29px; animation-delay: 0.4s"
                ></span>
                <span
                  class="particle-dot-reverse bg-violet-500 opacity-35"
                  style="top: 29px; animation-delay: 0.6s"
                ></span>
                <span
                  class="particle-dot-reverse bg-violet-500 opacity-20"
                  style="top: 29px; animation-delay: 0.8s"
                ></span>
              </div>
            </div>
            ...
            <div class="bg-white border-l border-gray-200 flex flex-col h-full">
              ...
              <div
                class="px-4 py-2.5 bg-white border-b border-gray-200 flex items-center gap-3"
              >
                <div class="flex items-center gap-2">
                  <div
                    class="w-7 h-7 rounded-md bg-violet-100 flex items-center justify-center"
                  >
                    <svg
              ...
              <div class="flex-1 overflow-auto">
                <table class="w-full border-collapse text-sm">
                  <thead class="sticky top-0 z-10">
                    <tr class="bg-gray-50">
                      <th
                        class="w-10 px-3 py-2 text-center text-[10px] font-medium text-gray-400 border-b border-r border-gray-200 bg-gray-50"
                      ></th>
                      <th
                        class="px-4 py-2 text-left text-[11px] font-semibold text-gray-600 border-b border-r border-gray-200 bg-gray-50"
                      >
                        Name
                      </th>
                      <th
                      ...
                      <th
                        class="px-4 py-2 text-left text-[11px] font-semibold text-gray-600 border-b border-gray-200 bg-gray-50"
                      >
                        Status
                      </th>
                    </tr>
                  ...
                  <tbody>
                    <tr class="group hover:bg-blue-50/50">
                      <td
                        class="px-3 py-2.5 text-center text-[10px] text-gray-400 border-b border-r border-gray-100 bg-gray-50/50"
                      >
                        1
                      </td>
                      <td
                        class="px-4 py-2.5 text-gray-900 border-b border-r border-gray-100"
                      >
                        Sarah Chen
                      </td>
                      <td
                        class="px-4 py-2.5 text-gray-600 border-b border-r border-gray-100"
                      >
                        Stripe
                      </td>
                      <td class="px-4 py-2.5 border-b border-r border-gray-100">
                        <span
                          class="inline-flex items-center justify-center w-8 h-6 rounded bg-emerald-100 text-emerald-700 text-xs font-semibold"
                          >92</span
                        >
                      </td>
                      <td class="px-4 py-2.5 border-b border-gray-100">
                        <span
                          class="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium bg-emerald-100 text-emerald-700"
                          >● Qualified</span
                        >
                      </td>
                    </tr>
                    <tr class="group hover:bg-blue-50/50">
                      ...
                      <td class="px-4 py-2.5 border-b border-r border-gray-100">
                        <span
                          class="inline-flex items-center justify-center w-8 h-6 rounded bg-amber-100 text-amber-700 text-xs font-semibold"
                          >68</span
                        >
                      </td>
                      <td class="px-4 py-2.5 border-b border-gray-100">
                        <span
                          class="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium bg-amber-100 text-amber-700"
                          >● Nurturing</span
                        >
                      </td>
                    </tr>
                    <tr class="group hover:bg-blue-50/50">
                      ...
                      <td class="px-4 py-2.5 border-b border-r border-gray-100">
                        <span
                          class="inline-flex items-center justify-center w-8 h-6 rounded bg-gray-100 text-gray-600 text-xs font-semibold"
                          >34</span
                        >
                      </td>
                      <td class="px-4 py-2.5 border-b border-gray-100">
                    ...
                    <tr class="group hover:bg-blue-50/50">
                      <td
                        class="px-3 py-2.5 text-center text-[10px] text-gray-400 border-r border-gray-100 bg-gray-50/50"
                      >
                        6
                      </td>
                      <td
                        class="px-4 py-2.5 text-gray-900 border-r border-gray-100"
                      >
                        Emma Wilson
                      </td>
                      <td
                        class="px-4 py-2.5 text-gray-600 border-r border-gray-100"
                      >
                        Linear
                      </td>
              ...
              <!-- Status bar footer -->
              <div
                class="px-4 py-2 bg-gray-50 border-t border-gray-200 flex items-center justify-between text-[11px] text-gray-500"
              >
                <span>6 records</span>
                <span class="flex items-center gap-1.5">
                  <span
                    class="w-4 h-4 rounded bg-violet-100 flex items-center justify-center text-[9px]"
                    >🤖</span
                  >
...
const displayPiecesCount = computed(() =>
  pending.value ? 500 : piecesCount.value,
);
...
const integrationLogosCompact = [
  ...
  {
    name: "SAP Ariba",
    logo: "https://cdn.activepieces.com/pieces/sap-ariba.png",
  },
  {
    name: "NetSuite",
  ...
  },
  {
    ...
    logo: "https://cdn.activepieces.com/pieces/microsoft-teams.png",
  },
  ...
  {
    name: "Snowflake",
    logo: "https://cdn.activepieces.com/pieces/snowflake.png",
  },
  {
    name: "Microsoft Dynamics CRM",
    logo: "https://cdn.activepieces.com/pieces/microsoft-dynamics-crm.png",
  },
  {
    name: "Intercom",

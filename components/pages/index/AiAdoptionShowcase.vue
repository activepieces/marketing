    ...
    <div class="relative max-w-7xl mx-auto px-4">
      ...
      <div class="relative mt-32" style="height: 520px;">
        ...
        <div 
          ...
          style="padding-top: 140px; padding-right: 120px; padding-left: 80px; margin-top: -140px; margin-right: -120px; margin-left: -80px;"
        >
          <!-- Card stack container -->
          <div class="relative w-full h-full" style="padding-top: 140px; padding-left: 80px;">
            ...
            >
              <!-- Window frame -->
              <div class="absolute inset-0 rounded-t-xl overflow-hidden bg-white border border-gray-200 border-b-0 shadow-sm flex flex-col">
                ...
                <div 
                  ...
                  :class="activeCard === index ? 'py-2.5 bg-gray-50' : 'py-2 bg-gray-100'"
                >
                  <!-- Icon + Title -->
                  <div 
                  ...
                  >
                    ...
                    >
                      <component 
                        ...
                        :class="activeCard === index ? 'w-3 h-3' : 'w-2.5 h-2.5'"
                        weight="fill" 
                      />
                    </div>
                    <span 
                ...
                >
                            ...
                            <div class="flex flex-col items-center">
                              <div class="relative w-[72px] h-[72px]">
                                <svg class="w-full h-full -rotate-90" viewBox="0 0 72 72">
                                  <circle cx="36" cy="36" r="30" fill="none" stroke="#f3f4f6" stroke-width="5"/>
                                  <circle 
                                  ...
                                  />
                                  <defs>
                                    <linearGradient id="individualsGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                            ...
                            <div class="flex flex-col items-center">
                              <div class="relative w-[72px] h-[72px]">
                                <svg class="w-full h-full -rotate-90" viewBox="0 0 72 72">
                                  ...
                                  />
                                  <defs>
                                    <linearGradient id="teamsGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                          ...
                          <div class="space-y-3">
                            <div v-for="(team, tIdx) in adoptionByTeam" :key="team.name">
                              <div class="flex items-center justify-between mb-1.5">
                                <span class="text-xs font-medium text-gray-600">{{ team.name }}</span>
                                <span class="text-xs font-bold text-gray-900">{{ team.percent }}%</span>
                              </div>
                      ...
                      <div class="flex-1 flex flex-col gap-4">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                          ...
                          <div class="bg-white rounded-xl p-4 border border-gray-200/80">
                            ...
                            <div class="flex items-center gap-1 mt-2">
                              <span class="text-emerald-600 text-[10px] font-bold">↑ 34%</span>
                        ...
                        <div class="bg-white rounded-xl p-4 border border-gray-200/80">
                          ...
                          <div class="flex gap-2 h-24">
                            <!-- Y-axis labels -->
                            <div class="flex flex-col justify-between text-[9px] text-gray-400 font-medium shrink-0 pr-1">
                              <span>$30k</span>
                              <span>$15k</span>
                              <span>$0</span>
                            </div>
                            ...
                            <div class="flex-1 flex items-end gap-1.5 border-l border-b border-gray-100 pl-2 pb-1 relative">
                              ...
                              >
                                ...
                                <span class="text-[8px] font-semibold text-gray-500 mb-0.5">{{ bar.value }}</span>
                                <div 
                  ...
                  <div v-if="card.id === 'leaderboard'" class="h-full flex flex-col">
                    ...
                    <div class="flex items-center justify-between mb-4">
                      ...
                      <div class="flex items-center bg-gray-100 rounded-lg p-0.5">
                        ...
                        <span class="px-3 py-1.5 text-xs font-semibold rounded-md text-gray-400">
                          <span class="flex items-center gap-1.5">
                    ...
                    <div class="flex-1 bg-white rounded-xl border border-gray-200 overflow-hidden">
                      <!-- Table header -->
                      <div class="grid grid-cols-[1fr_140px_100px_90px] gap-2 px-4 py-2.5 bg-gray-50 border-b border-gray-200">
                        <div class="text-[11px] font-semibold text-gray-500 uppercase tracking-wide">Name</div>
                        <div class="text-[11px] font-semibold text-gray-500 uppercase tracking-wide">Badges</div>
                        <div class="text-[11px] font-semibold text-gray-500 uppercase tracking-wide text-right">Time Saved</div>
                        <div class="text-[11px] font-semibold text-gray-500 uppercase tracking-wide text-right">Active Flows</div>
                      </div>
                      ...
                      <div class="divide-y divide-gray-100">
                        ...
                        >
                          ...
                          <div class="text-right">
                            <span class="text-sm font-semibold text-gray-900 tabular-nums">{{ person.timeSaved }}</span>
                          </div>
                  ...
                  <div v-if="card.id === 'branding'" class="h-full relative overflow-hidden">
                    ...
                    <!-- Progress bar -->
                    <div class="absolute bottom-0 left-0 right-0 h-1 bg-black/5 overflow-hidden z-20">
                      <div 
...
const tableData = [
  { 
    ...
    color: '#8b5cf6',
    badges: [
      { name: 'Champion', icon: markRaw(PhTrophy), color: '#f59e0b', bg: '#fef3c7' },
      { name: 'On Fire', icon: markRaw(PhFire), color: '#f97316', bg: '#ffedd5' },
      { name: 'Power User', icon: markRaw(PhLightning), color: '#eab308', bg: '#fef9c3' },
      { name: 'Big Brain', icon: markRaw(PhBrain), color: '#06b6d4', bg: '#cffafe' },
      { name: 'First Flow', icon: markRaw(PhRocket), color: '#8b5cf6', bg: '#ede9fe' },
      { name: 'Team Player', icon: markRaw(PhHeart), color: '#ec4899', bg: '#fce7f3' },
      { name: 'Diamond', icon: markRaw(PhDiamond), color: '#3b82f6', bg: '#dbeafe' },
    ],
    timeSaved: '124h',
    activeFlows: 47
  },
  { 
    ...
    color: '#f59e0b',
    badges: [
      { name: 'Target Master', icon: markRaw(PhTarget), color: '#ef4444', bg: '#fee2e2' },
      { name: 'Power User', icon: markRaw(PhLightning), color: '#eab308', bg: '#fef9c3' },
      { name: 'On Fire', icon: markRaw(PhFire), color: '#f97316', bg: '#ffedd5' },
      { name: 'Crown', icon: markRaw(PhCrown), color: '#a855f7', bg: '#f3e8ff' },
    ],
    timeSaved: '98h',
    activeFlows: 38
  },
...
const brandColors = [
  // Food & Beverage
  { primary: '#E31837', secondary: '#FF3B52', name: 'Coca-Cola', icon: 'heart' },
  { primary: '#FFD700', secondary: '#FFE44D', name: "McDonald's", icon: 'star' },

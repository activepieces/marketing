                ...
                <div class="flex flex-row md:flex-col lg:flex-row gap-4 lg:items-center">
                    ...
                    <div class="w-full">
                        <div class="flex row justify-between items-center">
                            ...
                            <span v-if="piece.categories?.includes('PREMIUM')" class="ml-2 bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">

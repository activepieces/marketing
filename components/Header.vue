...
<template>
  <div>
    <ClientOnly>
      ...
      >
        <nav
          class="border-gray-200 px-4 h-[62px] lg:px-6 dark:bg-gray-800 max-[905px]:bg-white"
          :class="{ 'bg-white': isScrolled }"
        >
          <div
            class="flex flex-wrap space-x-10 h-full items-stretch justify-between mx-auto max-w-screen-xl max-[905px]:space-x-0"
          >
            <div
            ...
            <div
              class="flex flex-grow hidden text-base justify-between items-center w-full min-[906px]:flex min-[906px]:w-auto min-[906px]:order-1 max-[905px]:bg-white max-[905px]:w-full max-[905px]:max-h-dvh max-[905px]:flex-col max-[905px]:justify-start max-[905px]:items-stretch max-[905px]:overflow-scroll max-[905px]:!-mx-4 max-[905px]:px-4 max-[905px]:h-[calc(100vh_-_62px)]"
              id="mobile-menu-2"
            >
              <ul
                class="flex flex-col min-[906px]:flex-row min-[906px]:items-center min-[906px]:space-x-8 max-[905px]:w-full"
              >
                <!-- Product Mega Menu -->
                <li class="relative group">
                  <!-- Hover Bridge -->
                  <div
                    class="absolute left-0 top-0 w-full h-[calc(100%+10px)] opacity-0"
                  ></div>

                  <!-- Menu Button -->
                  <button
                    class="flex items-center gap-1 py-2 text-black group-hover:text-[#8142e3] transition-colors duration-200"
                  >
                    <span class="font-normal">Product</span>
                    <svg
                      class="w-4 h-4 transition-transform duration-200 ease-in-out transform origin-center group-hover:rotate-180"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <!-- Mega Menu Content -->
                  <div
                    class="absolute left-0 top-full z-50 w-[700px] rounded-2xl shadow-2xl bg-white p-6 grid grid-cols-[3fr_2fr] gap-6 block transition-all duration-300 delay-200 transform translate-y-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 group-hover:delay-0 border border-gray-100 pointer-events-none group-hover:pointer-events-auto"
                  >
                    ...
                    <div class="flex min-w-0 flex flex-col gap-0">
                      ...
                      <a
                        href="/pieces"
                        class="flex items-center gap-4 h-20 rounded-xl hover:bg-gray-100 transition px-4 py-4 group/feature"
                      >
                        <div
                          class="w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-purple-100 to-purple-200"
                        >
                          <svg
                            class="w-6 h-6"
                            fill="#A259FF"
                        ...
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                            ...
                            >
                            <span
                              class="bg-purple-100 text-purple-700 text-xs font-semibold rounded-full px-2 py-0.5 h-6 flex items-center"
                            >
                          ...
                          <div
                            class="text-sm text-gray-500 group-hover/feature:text-gray-900 transition-colors duration-200"
                          >
                            Build AI agents across your apps
                          </div>
                        </div>
                      </a>
                      <!-- Feature Row 2 -->
                      ...
                      >
                        <div
                          class="w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-pink-100 to-pink-200"
                        >
                          <svg
                            class="w-6 h-6"
                            fill="#EC4899"
                        ...
                        <div class="flex-1">
                          <div class="flex items-center gap-2">
                            ...
                            >
                            <span
                              class="bg-gray-50 text-gray-500 text-xs font-medium rounded-full px-2 py-0.5 h-6 flex items-center border border-gray-200"
                              >DOCS</span
                            >
                          </div>
                          <div
                            class="text-sm text-gray-500 group-hover/feature:text-gray-900 transition-colors duration-200"
                          >
                            Start on our cloud or self-host with Docker
                          </div>
                        </div>
                      </a>
                      <!-- Feature Row 3 -->
                      ...
                      >
                        <div
                          class="w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-green-100 to-green-200"
                        >
                          <svg
                            class="w-6 h-6"
                            fill="#34C759"
                        ...
                        <div class="flex-1">
                          ...
                          <div
                            class="text-sm text-gray-500 group-hover/feature:text-gray-900 transition-colors duration-200"
                          >
                            Our impressive builder in your app
                          </div>
                        </div>
                      </a>
                      <!-- Feature Row 4 -->
                      <a
                        href="https://www.activepieces.com/docs/security/practices"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="flex items-center gap-4 h-20 rounded-xl hover:bg-gray-100 transition px-4 py-4 group/feature"
                      >
                        <div
                          class="w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-indigo-100 to-indigo-200"
                        >
                          <svg
                            class="w-6 h-6"
                            fill="#6366F1"
                    ...
                    <div class="flex min-w-0 flex flex-col gap-0">
                      ...
                      <a href="/mcp" class="block mb-4">
                        <div
                          class="p-4 rounded-xl bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800 border border-slate-500 w-fit hover:from-slate-900 hover:via-slate-800 hover:to-slate-900 hover:border-slate-700 transition-all duration-300 relative overflow-hidden"
                        >
                          <!-- Animated background elements -->
                          <div
                            class="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(100,116,139,0.1),transparent_50%)] animate-pulse"
                          ></div>
                          <div
                            class="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(100,116,139,0.1)_50%,transparent_75%)] bg-[length:250%_250%] animate-gradient"
                          ></div>
                          ...
                          <div class="relative">
                            <div class="flex items-center gap-2">
                              <span
                                class="font-bold text-white text-lg tracking-tight"
                                >MCP for Agents</span
                              >
                              <span
                                class="bg-gradient-to-r from-slate-400/30 via-slate-300/30 to-slate-200/30 text-white text-xs font-semibold rounded-full px-2 py-0.5 h-6 flex items-center backdrop-blur-sm border border-slate-400/30"
                                >NEW</span
                              >
                            </div>
                            <div class="text-xs text-white/80 mt-1 font-light">
                              Give your AI superpowers and let it do the work
                              for you
                            </div>
                          </div>
                        </div>
                      ...
                      <div
                        class="text-xs font-medium text-gray-500 uppercase tracking-wider mt-4 mb-2"
                      >
                        By Integration
                      </div>
                      <div class="flex flex-col">
                        <a
                          href="/pieces/gmail"
                          class="flex items-center gap-2 h-10 rounded-xl hover:bg-gray-100 transition -ml-4 px-4"
                        >
                        ...
                        <a
                          href="/pieces"
                          class="flex items-center h-10 -ml-4 px-4 group/all-integrations"
                        >
                          <div class="flex items-center gap-2">
                            <span
                              class="text-sm text-gray-900 group-hover/all-integrations:text-blue-600 transition-colors duration-300"
                              >All integrations</span
                            >
                            <svg
                              class="w-4 h-4 text-gray-900 group-hover/all-integrations:text-blue-600 transition-colors duration-300"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                ...
                <li class="relative group">
                  ...
                  <!-- Mega Menu Content -->
                  <div
                    class="absolute left-0 top-full z-50 w-[800px] rounded-2xl shadow-2xl bg-white p-6 grid grid-cols-3 gap-6 block transition-all duration-300 delay-200 transform translate-y-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 group-hover:delay-0 border border-gray-100 pointer-events-none group-hover:pointer-events-auto"
                  >
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      <a
                        href="https://www.activepieces.com/docs/flows/building-flows"
                        class="flex items-start gap-3 p-2 rounded-lg hover:bg-gray-50 group/item"
                      >
                        <div
                          class="w-8 h-8 flex items-center justify-center rounded-lg bg-blue-50 group-hover/item:bg-blue-100 transition-colors"
                        >
                          <svg
                        ...
                        <div>
                          ...
                          <div class="text-sm text-gray-500">
                            Learn how Activepieces works
                          </div>
                        </div>
                      </a>
                      <a
                        href="https://www.youtube.com/playlist?list=PLczrB0CK7kLKRlt_VSM2p5VaVSO1FSPG-"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="flex items-start gap-3 p-2 rounded-lg hover:bg-gray-50 group/item"
                      >
                      ...
                      <a
                        href="https://www.youtube.com/playlist?list=PLczrB0CK7kLJzlRmHL7c8sMYo6L3CbyjI"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="flex items-start gap-3 p-2 rounded-lg hover:bg-gray-50 group/item"
                      >
                        ...
                        >
                          ...
                          >
                            <path
                              ...
                              stroke-linejoin="round"
                              stroke-width="2"
                              d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"
                            />
                          </svg>
                        </div>
                        <div>
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      >
                        <div
                          class="w-8 h-8 flex items-center justify-center rounded-lg bg-purple-50 group-hover/item:bg-purple-100 transition-colors"
                        >
                          <svg
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      >
                        <div
                          class="w-8 h-8 flex items-center justify-center rounded-lg bg-green-50 group-hover/item:bg-green-100 transition-colors"
                        >
                          <svg
                ...
                <li>
                  <a
                    href="/pricing"
                    class="py-2 text-black hover:text-[#8142e3] transition-colors duration-200 font-normal"
                    >Pricing</a
                  >
                </li>
                <li>
                ...
                <a href="/mcp" class="block mb-4">
                  ...
                  >
                    ...
                    <div class="relative">
                      ...
                      <div class="text-xs text-white/80 mt-1 font-light">
                        Give your AI superpowers and let it do the work for you
                      </div>
                    </div>
                  </div>
                </a>
          ...
          <li>
            ...
            >
              <div class="py-4 space-y-4">
                ...
                <div>
                  <h3 class="text-sm font-semibold text-gray-500 mb-2 px-4">
                    Use Activepieces
                  </h3>
                  <div class="space-y-2">
                    <a

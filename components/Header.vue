  ...
  >
    <nav class="border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      ...
      >
        ...
        >
          <ul
            class="flex flex-col mt-4 font-medium min-[1251px]:items-center min-[1251px]:flex-row min-[1251px]:space-x-8 min-[1251px]:mt-0"
          >
            <li class="group">
              <button
            ...
            <li>
              <a
                ...
                target="_blank"
                class="p-[2px] relative inline-flex items-center text-sm font-medium text-white bg-gradient-to-r from-[#6232cf] to-[#5d8af3] rounded-full shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:rotate-3 max-[1250px]:mt-3"
              >
                <span

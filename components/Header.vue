...
<template>
  <header class="max-[1200px]:bg-white" :class="`sticky top-0 z-10 transition-colors duration-300 ${isScrolled ? 'bg-white shadow-md' : 'bg-transparent'
    }`">
    <nav class="border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <div class="flex flex-row items-center max-[555px]:overflow-hidden max-[555px]:w-[30px]">
          <NuxtLink to="/" class="flex items-center">
            <img src="/activepieces-logo-hz-og.svg" width="200" height="100"
        ...
        <div class="flex items-center min-[1201px]:order-2">
          <a href="https://cloud.activepieces.com/sign-in"
            class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 lg:px-5 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 max-[555px]:hidden">Login</a>
          <div class="flex flex-row gap-x-2">
            <router-link to="/sales" :class="route.path === '/open-source'
            ...
            <a href="https://cloud.activepieces.com/sign-up" :class="route.path === '/open-source'
                ? 'order-2 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 lg:px-5 lg:py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800'
                : 'order-1 text-gray-700 bg-white border border-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 lg:px-5 lg:py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800'
              ">Start free</a>
          </div>
          <button ref="mobileMenu" data-collapse-toggle="mobile-menu-2" type="button"
            ...
            aria-controls="mobile-menu-2" :aria-expanded="menuExpanded" @click="menuExpanded = !menuExpanded">
          ...
          <ul
            ...
            <li class="group">
              ...
              <div id="product-nav-menu"
                ...
                <ul class="py-4 px-2 text-lg font-medium text-gray-500 dark:text-gray-400 overflow-hidden"
                  ...
                  <li>
                    <NuxtLink to="https://www.activepieces.com/request-a-feature"
            ...
            <li class="group">
              ...
              <div id="resources-nav-menu"
                class="hidden max-min-[1201px]:!static !inset-x-auto !inset-y-auto !transform-none min-[1201px]:!block min-[1201px]:!opacity-0 min-[1201px]:!h-0 min-[1201px]:absolute z-10 bg-white rounded divide-y divide-gray-100 min-[1201px]:shadow-2xl dark:bg-gray-700 transition-opacity duration-[400ms] min-[1201px]:group-hover:!h-auto min-[1201px]:hover:!h-auto min-[1201px]:hover:!opacity-100 min-[1201px]:group-hover:!opacity-100 overflow-hidden">
                <ul class="py-4 px-2 text-lg font-medium text-gray-500 dark:text-gray-400 overflow-hidden"
                  aria-labelledby="dropdown-button2">
                  <li>
                    <NuxtLink to="https://community.activepieces.com/c/tutorials/10"
                  ...
                  <li>
                    <NuxtLink to="https://community.activepieces.com/"
                  ...
                  <li>
                    <NuxtLink to="https://www.activepieces.com/docs"
            ...
            <li>
              <a href="https://github.com/activepieces/activepieces" target="_blank"
                ...
                <span class="flex gap-x-2 w-full bg-gray-900 bg-white text-gray-800 rounded-full px-4 py-2">
                  <svg viewBox="0 0 16 16" width="16" height="16" class="w-5 h-5" aria-hidden="true" fill="#1f2937">
                    <path
  ...
  <div v-if="showGitHubBadge" class="opacity-100 transition-all fixed w-full justify-center bottom-16 z-[1] flex">
    <div
      ...
      <div class="overflow-hidden min-w-[97.57px] max-h-[28px]">
        <a class="github-button" href="https://github.com/activepieces/activepieces" data-icon="octicon-star"
          data-size="large" data-show-count="true" aria-label="Star activepieces/activepieces on GitHub"></a>
      </div>
      <svg @click="(showGitHubBadge = false), (gitHubBadgeHidden = 'true')" class="cursor-pointer" width="18"

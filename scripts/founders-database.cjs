...
module.exports = {
  // === NEW ADDITIONS ===
  'activepieces': { first: 'Ashraf', last: 'Samhouri', company: 'Activepieces' },
  'claude': { first: 'Dario', last: 'Amodei', company: 'Anthropic' },
  'anthropic': { first: 'Dario', last: 'Amodei', company: 'Anthropic' },
  'azure-openai': { first: 'Satya', last: 'Nadella', company: 'Microsoft' },
  'azure-blob-storage': { first: 'Satya', last: 'Nadella', company: 'Microsoft' },
  'azure-communication-services': { first: 'Satya', last: 'Nadella', company: 'Microsoft' },
  'binance': { first: 'Changpeng', last: 'Zhao', company: 'Binance' },
  'bluesky': { first: 'Jay', last: 'Graber', company: 'Bluesky' },
  'cloudinary': { first: 'Itai', last: 'Lahan', company: 'Cloudinary' },
  'checkout': { first: 'Guillaume', last: 'Pousaz', company: 'Checkout.com' },
  'copy-ai': { first: 'Chris', last: 'Lu', company: 'Copy.ai' },
  'cursor': { first: 'Michael', last: 'Truell', company: 'Anysphere' },
  'dify': { first: 'Zhang', last: 'Luyu', company: 'Dify' },
  'dropcontact': { first: 'Denis', last: 'Cohen', company: 'Dropcontact' },
  'e2b': { first: 'Vasek', last: 'Mlejnsky', company: 'E2B' },
  'exa': { first: 'Will', last: 'Bryk', company: 'Exa' },
  'fal-ai': { first: 'Anil', last: 'Akarsu', company: 'Fal.ai' },
  'gladia': { first: 'Jean-Louis', last: 'Queguiner', company: 'Gladia' },
  'growthbook': { first: 'Jeremy', last: 'Daly', company: 'GrowthBook' },
  'heygen': { first: 'Joshua', last: 'Xu', company: 'HeyGen' },
  'huggingface': { first: 'Clement', last: 'Delangue', company: 'Hugging Face' },
  'ideogram': { first: 'Mohammad', last: 'Norouzi', company: 'Ideogram' },
  'interakt': { first: 'Samved', last: 'Shetty', company: 'Interakt' },
  'jina': { first: 'Han', last: 'Xiao', company: 'Jina AI' },
  'kestra': { first: 'Emmanuel', last: 'Duchene', company: 'Kestra' },
  'krisp': { first: 'Artavazd', last: 'Minasyan', company: 'Krisp' },
  'lindy-ai': { first: 'Florent', last: 'Crivello', company: 'Lindy' },
  'lmnt': { first: 'Sam', last: 'Narvey', company: 'LMNT' },
  'llamaindex': { first: 'Jerry', last: 'Liu', company: 'LlamaIndex' },
  'mailreach': { first: 'Jean-Charles', last: 'Bouteiller', company: 'MailReach' },
  'mapbox': { first: 'Eric', last: 'Gundersen', company: 'Mapbox' },
  'mem': { first: 'Dennis', last: 'Xu', company: 'Mem' },
  'mintlify': { first: 'Han', last: 'Wang', company: 'Mintlify' },
  'mojoauth': { first: 'Rakesh', last: 'Soni', company: 'MojoAuth' },
  'nango': { first: 'Robin', last: 'Guldener', company: 'Nango' },
  'noem': { first: 'Paul', last: 'Engel', company: 'Noem' },
  'odoo': { first: 'Fabien', last: 'Pinckaers', company: 'Odoo' },
  'oneuptime': { first: 'Nawaz', last: 'Dhandala', company: 'OneUptime' },
  'orimon': { first: 'Prateek', last: 'Mehra', company: 'Orimon' },
  'owncloud': { first: 'Frank', last: 'Karlitschek', company: 'ownCloud' },
  'paigo': { first: 'Hao', last: 'Chen', company: 'Paigo' },
  'parseur': { first: 'Romain', last: 'Fleury', company: 'Parseur' },
  'plainly': { first: 'Tomislav', last: 'Grubisic', company: 'Plainly' },
  'playht': { first: 'Hammad', last: 'Syed', company: 'PlayHT' },
  'poper': { first: 'Anmol', last: 'Singh', company: 'Poper' },
  'portkey': { first: 'Rohit', last: 'Agarwal', company: 'Portkey' },
  'powtoon': { first: 'Ilya', last: 'Spitalnik', company: 'Powtoon' },
  'pushover': { first: 'Josh', last: 'Roberts', company: 'Pushover' },
  'quickzu': { first: 'Ahmed', last: 'Elsaadi', company: 'QuickZu' },
  'reoon': { first: 'Ramazan', last: 'Karkin', company: 'Reoon' },
  'respell': { first: 'Rohan', last: 'Pandey', company: 'Respell' },
  'rss': { first: 'Dave', last: 'Winer', company: 'RSS' },
  'runware': { first: 'Mohamed', last: 'Aboelez', company: 'Runware' },
  'salesmate': { first: 'Jayesh', last: 'Khamar', company: 'Salesmate' },
  'satismeter': { first: 'Ondrej', last: 'Sedlacek', company: 'Satismeter' },
  'scrapeowl': { first: 'Michael', last: 'Chen', company: 'ScrapeOwl' },
  'sendpulse': { first: 'Constantine', last: 'Rozenshtrakh-Makarov', company: 'SendPulse' },
  'serper': { first: 'Serper', last: 'Team', company: 'Serper' },
  'serpapi': { first: 'Ilya', last: 'Zub', company: 'SerpApi' },
  'sftp': { first: 'Tatu', last: 'Ylonen', company: 'SSH' },
  'shortio': { first: 'David', last: 'Ngo', company: 'Short.io' },
  'simplero': { first: 'Calvin', last: 'Correli', company: 'Simplero' },
  'siterecognition': { first: 'James', last: 'Miller', company: 'SiteRecognition' },
  'skyvern': { first: 'Suchintan', last: 'Singh', company: 'Skyvern' },
  'slackbot': { first: 'Stewart', last: 'Butterfield', company: 'Slack' },
  'smartengage': { first: 'Ankit', last: 'Kanjlia', company: 'SmartEngage' },
  'smartsuite': { first: 'Jon', last: 'Gitlin', company: 'SmartSuite' },
  'speechify': { first: 'Cliff', last: 'Weitzman', company: 'Speechify' },
  'sproutsocial': { first: 'Justyn', last: 'Howard', company: 'Sprout Social' },
  'stablehost': { first: 'Ryan', last: 'Gray', company: 'StableHost' },
  'stdwebhook': { first: 'Tom', last: 'Hacohen', company: 'Standard Webhooks' },
  'streamelements': { first: 'Doron', last: 'Nir', company: 'StreamElements' },
  'sunbird': { first: 'Anika', last: 'Mehta', company: 'Sunbird' },
  'synthesia': { first: 'Victor', last: 'Riparbelli', company: 'Synthesia' },
  'tavily': { first: 'Asaf', last: 'Yigal', company: 'Tavily' },
  'tavus': { first: 'Hassan', last: 'Shabbir', company: 'Tavus' },
  'telegram-bot': { first: 'Pavel', last: 'Durov', company: 'Telegram' },
  'textmagic': { first: 'Priit', last: 'Vaikmaa', company: 'TextMagic' },
  'tinybird': { first: 'Jorge', last: 'Goncalves', company: 'Tinybird' },
  'trustpilot': { first: 'Peter', last: 'Holten Muhlmann', company: 'Trustpilot' },
  'twitch': { first: 'Emmett', last: 'Shear', company: 'Twitch' },
  'unified': { first: 'Pieter', last: 'Danhieux', company: 'Unified' },
  'unisender': { first: 'Alexey', last: 'Vinogradov', company: 'Unisender' },
  'unleash': { first: 'Ivar', last: 'Osterholt', company: 'Unleash' },
  'usetiful': { first: 'Vaclav', last: 'Neumann', company: 'Usetiful' },
  'userscom': { first: 'Marcin', last: 'Grodzicki', company: 'Users.com' },
  'vbout': { first: 'Richard', last: 'Castera', company: 'VBOUT' },
  'verifalia': { first: 'Antonio', last: 'Mauro', company: 'Verifalia' },
  'vero': { first: 'Chris', last: 'Hexton', company: 'Vero' },
  'voiceflow': { first: 'Braden', last: 'Ream', company: 'Voiceflow' },
  'webengage': { first: 'Avlesh', last: 'Singh', company: 'WebEngage' },
  'webchat': { first: 'Eric', last: 'Yuan', company: 'Zoom' },
  'webinarkit': { first: 'Stefan', last: 'Ciancio', company: 'WebinarKit' },
  'whois': { first: 'Jon', last: 'Postel', company: 'ICANN' },
  'windmill': { first: 'Ruben', last: 'Fiszel', company: 'Windmill' },
  'wonderchat': { first: 'Jiaqi', last: 'Pan', company: 'Wonderchat' },
  'woodpecker': { first: 'Matt', last: 'Tarczynski', company: 'Woodpecker' },
  'wordnet': { first: 'George', last: 'Miller', company: 'Princeton' },
  'writesonic': { first: 'Samanyou', last: 'Garg', company: 'Writesonic' },
  'xai': { first: 'Elon', last: 'Musk', company: 'xAI' },
  'yahoo': { first: 'Jerry', last: 'Yang', company: 'Yahoo' },
  'yammer': { first: 'David', last: 'Sacks', company: 'Yammer' },
  'zenefits': { first: 'Parker', last: 'Conrad', company: 'Zenefits' },
  'zep': { first: 'Daniel', last: 'Chalef', company: 'Zep' },
  'zerobounce': { first: 'Liviu', last: 'Tanase', company: 'ZeroBounce' },
  'zipwhip': { first: 'John', last: 'Lauer', company: 'Zipwhip' },
  'zixflow': { first: 'Neelesh', last: 'Sharma', company: 'Zixflow' },
